...
# board-core.js is generated by scripts/build-board-core.sh and vendor/tile-core.js is copied
# from this repo's tile-core/ — both local, both checked by scripts/test.sh's freshness gate.
#
...
echo "build complete — board-core.js via scripts/build-board-core.sh; vendor/tile-core.js copied from tile-core/;"

...
# engine is COPIED from this repo's dist/, like every other surface here.
#
...
# missed, so nothing in this repo had regenerated it since. Measured: vendor/editor-core.js was
# 193,714 bytes against the canonical 226,716 — 33 KB behind, on a preview that reported no
# problem at all, which is the exact failure hosts/web/tugtile/build.sh's own comment warns about ("three
...
echo "build complete — vendor/editor-core.js is copied from tile-core/;"

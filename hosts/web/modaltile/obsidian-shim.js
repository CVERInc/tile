// Web shim: run the UNCHANGED editor-core (Obsidian-flavoured) in a browser. No fork — the core is
// untouched and the APIs it expects are supplied here.
...
const ICONS = {
  ...
  'text-quote': '<path d="M3 5v14"/><path d="M8 7h13"/><path d="M8 12h13"/><path d="M8 17h13"/>',

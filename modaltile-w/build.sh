...
# hand-authored); the shared editor engine (vendor/tile-core.js) is VENDORED from the public
...
echo "build complete — vendor/tile-core.js is copied from this repo's tile-core/;"
echo "  obsidian-shim.js and host.js are committed static glue."
echo
echo "  run it:  (cd \"$ROOT\" && python3 -m http.server 8731)  →  http://localhost:8731/modaltile-w/"

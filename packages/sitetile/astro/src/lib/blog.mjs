...
// absent) keeps the historic literal en-US output byte-identical.
...
export function fmtDate(s, format, lang) {
  ...
  switch (fmt) {
    ...
    default:
      ...
      return new Intl.DateTimeFormat(lang ? toBcp47(lang) : 'en-US', { year: 'numeric', month: 'long', day: 'numeric' }).format(d);
  }
}

/*! coral sponsor@0.2.2 +5a60b64 — generated by dynamic-corals/build.mjs, do not edit */
(() => {
  // ../shared/dynamic-coral-css.mjs
  var DYNAMIC_CORAL_CSS_ATTR = "data-dynamic-coral-css";
  var DYNAMIC_CORAL_CSS_LAYERED = "layered";
  function withDynamicCoralCssLayer(css, doc) {
    const document_ = doc || (typeof document !== "undefined" ? document : null);
    const root = document_ ? document_.documentElement : null;
    const layered = !!root && typeof root.getAttribute === "function" && root.getAttribute(DYNAMIC_CORAL_CSS_ATTR) === DYNAMIC_CORAL_CSS_LAYERED;
...
${css}
  ...
  function mountSponsor(el, deps) {
    ...
    injectStyles(doc);
    const missing = !cfg.guildId ? "data-guild-id" : !cfg.apiBase ? "data-api-base" : !cfg.currency ? "data-currency" : "";
    if (missing) {
...
if (typeof window !== 'undefined') (window.__coralVersions=window.__coralVersions||{})['sponsor']='0.2.2';

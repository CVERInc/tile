...
export const CELL_STRINGS_BY_KEY = {
  ...
  'type.profile.chips.hint': {
    zh: '用逗號分開，例如「插畫家, 遠端」。',
    ja: 'カンマで区切ります（例：イラストレーター, リモート）。',
    en: 'Separate with commas, e.g. "Illustrator, remote".',
    ko: '쉼표로 구분해 주세요（예：일러스트레이터, 원격）.',
    'zh-Hans': '用逗号分开，例如「插画家, 远程」。',
    de: 'Mit Kommas trennen, z. B. „Illustratorin, Remote“.',
    fr: 'Séparez par des virgules, par exemple « Illustratrice, télétravail ».',
    es: 'Sepáralas con comas, por ejemplo «Ilustradora, remoto».',
    pt: 'Separe com vírgulas, por exemplo “Ilustradora, remoto”.',
  },
  ...
  'type.video.yt.label': {
    zh: 'YouTube 影片', ja: 'YouTube の動画', en: 'YouTube video',
    ko: 'YouTube 영상', 'zh-Hans': 'YouTube 视频',
    de: 'YouTube-Video', fr: 'Vidéo YouTube',
    es: 'Vídeo de YouTube', pt: 'Vídeo do YouTube',
  },
  'type.video.yt.hint': {
    zh: '貼上影片的網址，或只填編號，例如 youtube.com/watch?v=dQw4w9WgXcQ 或 dQw4w9WgXcQ。和「頻道」二選一。',
    ja: '動画のリンクを貼り付けるか、ID だけを入力します。例：youtube.com/watch?v=dQw4w9WgXcQ または dQw4w9WgXcQ。「チャンネル」とどちらか一方です。',
    ...
    ko: '영상 링크를 붙여 넣거나 ID만 적어요. 예: youtube.com/watch?v=dQw4w9WgXcQ 또는 dQw4w9WgXcQ. 「채널」과 둘 중 하나만 쓰세요.',
    'zh-Hans': '粘贴视频的网址，或只填编号，例如 youtube.com/watch?v=dQw4w9WgXcQ 或 dQw4w9WgXcQ。和「频道」二选一。',
    de: 'Fügen Sie den Link des Videos ein oder nur seine Kennung – etwa youtube.com/watch?v=dQw4w9WgXcQ oder dQw4w9WgXcQ. Entweder dies oder der Kanal, nicht beides.',
    fr: 'Collez le lien de la vidéo, ou son identifiant — par exemple youtube.com/watch?v=dQw4w9WgXcQ ou dQw4w9WgXcQ. Ceci ou la chaîne, pas les deux.',
    es: 'Pega el enlace del vídeo o su identificador, por ejemplo youtube.com/watch?v=dQw4w9WgXcQ o dQw4w9WgXcQ. Esto o el canal, no ambos.',
    pt: 'Cole o link do vídeo, ou o identificador dele — por exemplo youtube.com/watch?v=dQw4w9WgXcQ ou dQw4w9WgXcQ. Isto ou o canal, não os dois.',
  },
